...
public class NormalDistributionTest {
  ...
  void assertEquals(double expected, double actual, double ulp) {

    Assertions.assertThat(actual).isCloseTo(expected, Offset.offset(ulp));
  }
  ...
  public void testPdfStdMean() {
    ...
    System.out.println(
        "for x=" + x + " the pdf=" + pdf + " expected=" + expectedPdf + " within " + ulp);
  ...
  public void testPdfMaxAtMean() {
    ...
    double ulp = Math.ulp(expectedPdf);
    System.out.println(
        "for maxX=" + maxX + " the pdf=" + pdf + " expected=" + expectedPdf + " within " + ulp);
    assertEquals(expectedPdf, pdf, ulp);
  ...
  public void testPdfVsApacheMathNonstd() {
    ...
    double pdf = nd.pdf(x);
    org.apache.commons.math3.distribution.NormalDistribution and =
        new org.apache.commons.math3.distribution.NormalDistribution(34.3d, 3.22d);
    double expectedPdf = and.density(x);
    double ulp = Math.ulp(expectedPdf);
    System.out.println(
        "for mean/stdev 34.3d, 3.22d x="
            + x
            + " the pdf="
            + pdf
            + " expected(from Apache)="
  ...
  public void testCdf() {
    ...
    System.out.println(
        "for x=" + x + " the cdf=" + cdf + " expected=" + expectedCdf + " within " + ulp);
  ...
  public void testErrFunction() {
    ...
    double ulp = 1.0e-3;
    System.out.println(
        "erf, for x=" + 1 + " the erf=" + erf + " expectedErf=" + expectedErf + " within " + ulp);
